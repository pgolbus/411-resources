...
#Change 2: 'music_collection.utils.random_utils' --> 'meal_max.utils.random_utils'
from meal_max.utils.random_utils import get_random

#Change 1: 42 --> 0.42
RANDOM_NUMBER = 0.42
#Change 4: 'NUM_SONGS' --> 'SEED'; For readability
SEED = 100         
...
def test_get_random(mock_random_org):
    ...
    result = get_random() #result = get_random(SEED) maybe this is right
