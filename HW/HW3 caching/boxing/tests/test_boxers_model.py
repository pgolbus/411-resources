...
#def test_clear_ring(): #return True 
    #with pytest/raises(ValueError, match="model not cleared")
...
#def test_clear_ring_empty(): #return True # remove this
...
#def test_get_boxers_empty(): #return True# remove this
...
#def test_get_boxers_with_data(): #return True #remove this
...
#def test_get_boxers_uses_cache(): #return True # remove this
...
def test_get_boxers_empty(ring_model, caplog):
    with caplog.at_level("INFO"):
        boxers = ring_model.get_boxers()
    assert boxers == []
    assert "Retrieved 0 boxers for the ring." in caplog.text
...
>>>>>>> f0aa8514c85ee00b87d41c4eafb1678fcedeeb69
#def test_get_boxers_refreshes_on_expired_ttl(): #return True #remove this 
...
#def test_cache_populated_on_get_boxers(): #return True #remove this
...
#def test_enter_ring(): #return True #remove this
...
#def test_enter_ring_full(): #return True # remove this
<<<<<<< HEAD
=======
<<<<<<< HEAD
>>>>>>> 8fc7ad0 (uncommented test_ring_model)
