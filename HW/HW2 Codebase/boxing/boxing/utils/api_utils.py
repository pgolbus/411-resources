...
def get_random() -> float:
    """
    Fetches a random decimal fraction between 0 and 1 from random.org.

    Returns:
        float: A random decimal between 0 and 1.
    ...
    try:
        ...
        logger.info(f"Received random decimal: {random_number}")
